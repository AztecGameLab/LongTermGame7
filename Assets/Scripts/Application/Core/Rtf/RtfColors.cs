namespace Application.Core.Rtf
{
    ...
    {
        /// <summary> The color aqua. </summary>
        ...
        /// <summary> The color fuchsia. </summary>
        ...
        /// <summary> The color silver. </summary>
