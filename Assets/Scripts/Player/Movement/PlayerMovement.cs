...
public class PlayerMovement : MonoBehaviour
{
    ...
    [SerializeField] private float _accelerationSmoothTime; //Acceleration & Deceleration speed
    [SerializeField] private float _reverseMultiplier; //Used to cut _accelerationSmoothTime to allow more snappy movement when changing direction
